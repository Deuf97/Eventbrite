...
User.create(first_name: "jean", email:"jean@yopmail.com")
User.create(first_name: "paul", email:"paul@yopmail.com")
User.create(first_name: "kevin", email:"kevin@yopmail.com")
